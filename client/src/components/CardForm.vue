<template>
  <div class="card-form">
    ...
    <div class="card-form__inner darkCard">
      <div class="card-input">
        <label for="cardNumber" class="card-input__label darkText--text">Card Number</label>
        <input
          type="tel"
          ...
          @blur="blurCardNumber"
          class="card-input__input darkText--text"
      ...
      <div class="card-input">
        <label for="cardName" class="card-input__label darkText--text">Card Name</label>
        <input
          type="text"
          :id="fields.cardName"
          v-letter-only
      ...
      <div class="card-form__row">
        <div class="card-form__col">
          <div class="card-form__group">
            <label for="cardMonth" class="card-input__label darkText--text">Expiration Date</label>
            <select
              class="card-input__input -select darkText--text"
              :id="fields.cardMonth"
        ...
        <div class="card-form__col -cvv">
          <div class="card-input">
            <label for="cardCvv" class="card-input__label darkText--text">CVV</label>
            <input
              type="tel"
              class="card-input__input darkText--text"
              v-number-only
      ...
      <button class="card-form__button primary" v-on:click="invaildCard">SUBMIT</button>
    </div>
  </div>
</template>
